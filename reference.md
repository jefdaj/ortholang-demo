...
<br/>
{{ macros.load_cut(user, 'examples/replace.ol') }}
</div>
<div class="moduleblock">
<h3>Repeat module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/repeat.ol') }}
</div>
<div class="moduleblock">
<h3>Math module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/math.ol') }}
</div>
<div class="moduleblock">
<h3>Load module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/load.ol') }}
</div>
<div class="moduleblock">
<h3>Sets module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/sets.ol') }}
</div>
<div class="moduleblock">
<h3>SeqIO module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/seqio.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/biomartr.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/blastdb.ol') }}
</div>
<div class="moduleblock">
<h3>BLAST+ module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/blast.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/blasthits.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/listlike.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/psiblast.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/crbblast.ol') }}
</div>
<div class="moduleblock">
<h3>HMMER module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/hmmer.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/blastrbh.ol') }}
</div>
<div class="moduleblock">
<h3>MUSCLE module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/muscle.ol') }}
</div>
<div class="moduleblock">
<h3>Sample module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/sample.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/permute.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/summarize.ol') }}
</div>
<div class="moduleblock">
<h3>Scores module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/scores.ol') }}
</div>
<div class="moduleblock">
<h3>Plots module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/plots.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/orthofinder.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/diamond.ol') }}
</div>
<div class="moduleblock">
<h3>MMSeqs module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/mmseqs.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/sonicparanoid.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/orthogroups.ol') }}
</div>
<div class="moduleblock">
<h3>Busco module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/busco.ol') }}
</div>
<div class="moduleblock">
<h3>Range module</h3>
...
<br/>
{{ macros.load_cut(user, 'examples/range.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/setstable.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/allvsall.ol') }}
</div>
<div class="moduleblock">
...
<br/>
{{ macros.load_cut(user, 'examples/greencut.ol') }}
</div>
