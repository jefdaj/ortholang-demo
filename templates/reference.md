...
0.8.4.7, along with short examples of their use. If you don't find something
...
| `ortholog_in_min` | `num`, `spr`, `faa.list` | `str.list.list` |
| `ortholog_in_max` | `num`, `spr`, `faa.list` | `str.list.list` |
